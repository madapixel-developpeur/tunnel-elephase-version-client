...
class InventaireFilleFormType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('produit', EntityType::class, [
                ...
                'required' => false,
                'class'=> Product::class,
                'choice_label' => function(?Product $produit) {
                    return $produit ? $produit->getName() : '';
                },
                'constraints' => [
    ...
    {
        $resolver->setDefaults(['data_class' => InventaireFille::class]);
    }
}
